...
const SignUp = () => {
  ...
  const {register, formState: {errors}, handleSubmit, getValues, setValue, watch} = useForm();
  ...
  return (
    <div className={signUp.page}>
      <form className={signUp.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        {errors.agreement &&
          <p className={signUp.error}>{errors.agreement.message}</p>}
        ...
        <span className={signUp.signInLabel}>
          Already have an account? <Link className={signUp.signIn} to="/sign-in">Sign In.</Link>
        </span>
